      ...
      <CardContent className="p-5 sm:p-6">
        <div className="flex">
          <div className="flex-1 text-center sm:text-left">
            <div className="text-sm text-foreground/50 mb-1">今日完成</div>
            <div className="flex items-baseline gap-2 justify-center sm:justify-start">
              <span className="text-3xl sm:text-4xl font-bold text-primary">{stats.count}</span>
              <span className="text-foreground/50">个番茄</span>
            </div>
          ...
          <div className="w-px bg-border mx-3 sm:mx-6" />

          <div className="flex-1 text-center sm:text-right">
            <div className="text-sm text-foreground/50 mb-1">连续专注</div>
            <div className="flex items-baseline gap-2 justify-center sm:justify-end">
              ...
              <span className="text-foreground/50">天</span>
            </div>
          </div>
        </div>
      </CardContent>
